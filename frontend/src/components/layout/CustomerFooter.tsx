...
export const CustomerFooter: React.FC = () => {
  ...
  return (
    <footer className="py-8 border-t border-indigo-100/70 dark:border-white/10 bg-white/70 dark:bg-brand-darkSurface/60 text-xs text-slate-500 dark:text-slate-400 select-none">
      <Container size="lg" className="space-y-6">
        {/* Brand & App Info Row */}
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-indigo-50 dark:border-white/5 pb-6">
